...
const images = [
  ...
  { src: "/images/trail/3-detail.png", alt: "步道詳情" },
  { src: "/images/trail/4-favorites.png", alt: "口袋名單" },
];
            ...
            <section>
              ...
              <div className="flex flex-wrap gap-2">
                {["React 19", "TypeScript", "Vite", "MUI v7", "ASP.NET Core 8", "PostgreSQL", "JWT", "Google OAuth", "Leaflet", "Cloudinary"].map(t => (
                  <span key={t} className="tech-tag text-xs px-2.5 py-1 rounded border font-mono cursor-default"
